          ...
          <div className="overflow-x-auto rounded-xl border border-slate-200">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                ...
                <tr className="hover:bg-slate-50"><td className="px-4 py-2.5"><code className="text-pink-600 font-semibold">happyhorse-1.1-t2v</code></td><td className="px-4 py-2.5">T2V</td><td className="px-4 py-2.5 text-slate-600">文生视频 (1.1)</td><td className="px-4 py-2.5 text-slate-600">720P ¥0.9/s / 1080P ¥1.2/s</td></tr>
                <tr className="hover:bg-slate-50"><td className="px-4 py-2.5"><code className="text-pink-600 font-semibold">happyhorse-1.1-i2v</code></td><td className="px-4 py-2.5">I2V</td><td className="px-4 py-2.5 text-slate-600">图生视频 (1.1)</td><td className="px-4 py-2.5 text-slate-600">720P ¥0.9/s / 1080P ¥1.2/s</td></tr>
                <tr className="hover:bg-slate-50"><td className="px-4 py-2.5"><code className="text-pink-600 font-semibold">happyhorse-1.1-r2v</code></td><td className="px-4 py-2.5">R2V</td><td className="px-4 py-2.5 text-slate-600">参考图生视频 (1.1)</td><td className="px-4 py-2.5 text-slate-600">720P ¥0.9/s / 1080P ¥1.2/s</td></tr>
              </tbody>
            </table>
          </div>
        </div>
