...
# ── GPT Image 2 (OG image2_*) ───────────────────────────────────────────────
# Three quality tiers: 1K / 2K / 4K.
# Nine aspect ratios: 1:1, 3:2, 2:3, 3:4, 4:3, 16:9, 9:16, 21:9, 9:21.
# Maximum edge length <= 3840.
# Recommended sizes: 1024x1024, 1536x1024, 1024x1536, 2048x2048,
#                    2048x1152, 3840x2160, 2160x3840.
# The TencentVOD API uses AspectRatio + Resolution tier labels, not pixel
# dimensions.  WxH entries are provided for size="WxH" lookup convenience.
_OG_IMAGE2_SIZES: SizeTable = {
    # 1:1
    "1024x1024":  ("1:1",  "1K"),
    "2048x2048":  ("1:1",  "2K"),
    "3840x3840":  ("1:1",  "4K"),
