...
TENCENTVOD_TEMPLATES = [
    ...
    # Vidu Q3 Mix — 720p/1080p, no audio tier.
    dict(
        label='Vidu Q3 Mix (TencentVOD)',
        provider='TencentVOD',
        name='viduq3-mix',
        alias='viduq3-mix',
        context_size=4096, input_size=4096, output_size=1,
        ...
        output_pricing={
            'video': {
                ...
                'price': 0.782,
                'tiers': [
                    {'resolution': '720p', 'price': 0.782},
                    {'resolution': '1080p', 'price': 0.938},
                    {'resolution': '2K', 'price': 1.126},
                    {'resolution': '4K', 'price': 1.352},
                ],
            },
        },
        input_price=0, output_price=0, cache_creation_price=0, cache_hit_price=0,
    ...
    dict(
        ...
        output_pricing={
            'video': {
                ...
                'price': 0.625,
                'tiers': [
                    {'resolution': '480p', 'price': 0.313},
                    {'resolution': '720p', 'price': 0.625},
                    {'resolution': '1080p', 'price': 0.782},
                    {'resolution': '2K', 'price': 0.939},
                    {'resolution': '4K', 'price': 1.127},
                ],
            },
        },
        input_price=0, output_price=0, cache_creation_price=0, cache_hit_price=0,
    ...
    dict(
        label='Vidu Q3 Turbo (TencentVOD)',
        provider='TencentVOD',
        name='viduq3-turbo',
        alias='viduq3-turbo',
        context_size=4096, input_size=4096, output_size=1,
        ...
        output_pricing={
            'video': {
                ...
                'price': 0.375,
                'tiers': [
                    {'resolution': '480p', 'price': 0.25},
                    {'resolution': '720p', 'price': 0.375},
                    {'resolution': '1080p', 'price': 0.438},
                    {'resolution': '2K', 'price': 0.526},
                    {'resolution': '4K', 'price': 0.631},
                ],
            },
        },
        input_price=0, output_price=0, cache_creation_price=0, cache_hit_price=0,
    ...
    # Pixverse V6 — text-to-video, image-to-video (no aspect_ratio for i2v).
    dict(
        label='Pixverse V6 (TencentVOD)',
        provider='TencentVOD',
        name='pixverse-v6',
        alias='pixverse-v6',
        context_size=4096, input_size=4096, output_size=1,
        ...
        output_pricing={
            'video': {
                ...
                'price': 0.264,
                'tiers': [
                    {'resolution': '480p', 'audio': False, 'price': 0.205},
                    {'resolution': '540p', 'audio': False, 'price': 0.205},
                    {'resolution': '720p', 'audio': False, 'price': 0.264},
                    {'resolution': '1080p', 'audio': False, 'price': 0.528},
                    {'resolution': '2K', 'audio': False, 'price': 0.634},
                    {'resolution': '4K', 'audio': False, 'price': 0.769},
                    {'resolution': '480p', 'audio': True, 'price': 0.264},
                    {'resolution': '540p', 'audio': True, 'price': 0.264},
                    {'resolution': '720p', 'audio': True, 'price': 0.352},
                    {'resolution': '1080p', 'audio': True, 'price': 0.675},
                    {'resolution': '2K', 'audio': True, 'price': 0.810},
                    {'resolution': '4K', 'audio': True, 'price': 0.971},
                ],
            },
        },
        input_price=0, output_price=0, cache_creation_price=0, cache_hit_price=0,
    ...
    dict(
        ...
        output_pricing={
            'video': {
                ...
                'price': 0.293,
                'tiers': [
                    {'resolution': '480p', 'audio': False, 'price': 0.235},
                    {'resolution': '540p', 'audio': False, 'price': 0.235},
                    {'resolution': '720p', 'audio': False, 'price': 0.293},
                    {'resolution': '1080p', 'audio': False, 'price': 0.557},
                    {'resolution': '2K', 'audio': False, 'price': 0.669},
                    {'resolution': '4K', 'audio': False, 'price': 0.803},
                    {'resolution': '480p', 'audio': True, 'price': 0.293},
                    {'resolution': '540p', 'audio': True, 'price': 0.293},
                    {'resolution': '720p', 'audio': True, 'price': 0.381},
                    {'resolution': '1080p', 'audio': True, 'price': 0.704},
                    {'resolution': '2K', 'audio': True, 'price': 0.845},
                    {'resolution': '4K', 'audio': True, 'price': 1.014},
                ],
            },
        },
        input_price=0, output_price=0, cache_creation_price=0, cache_hit_price=0,
    ...
    # Hunyuan 3D 2.0 — image_generation → 3d_panorama, 3d_generation → 3d_scene.
    dict(
        label='Hunyuan 3D 2.0 (TencentVOD)',
        provider='TencentVOD',
        name='hunyuan-3d-2.0',
        alias='hunyuan-3d-2.0',
        context_size=4096, input_size=4096, output_size=1,
        pricing_tiers=None,
        output_pricing={
            '3d': {
