"""Google Gemini model templates (chat, image, video)."""
...
GOOGLE_TEMPLATES = [
    ...
    dict(label='Gemini 3 Pro Preview', provider='Google', name='gemini-3-pro-preview', alias='gemini-3-pro-preview',
         ...
         support_file=True, support_web_search=True, support_tool_search=False,
         support_thinking=True, support_online_image=True, support_online_video=True, support_embedding=False),
    dict(label='Gemini 3.5 Flash', provider='Google', name='gemini-3.5-flash', alias='gemini-3.5-flash',
    ...
    dict(
        label='Veo 3.1 Fast Generate (Gemini)',
        provider='Google',
        name='veo-3.1-fast-generate-preview',
        alias='veo-3.1-fast-generate-preview',
        context_size=4096, input_size=4096, output_size=1,
        pricing_tiers=None,
        output_pricing={
            'video': {
    ...
    dict(
        label='Veo 3.1 Lite Generate (Gemini)',
        provider='Google',
        name='veo-3.1-lite-generate-preview',
        alias='veo-3.1-lite-generate-preview',
        context_size=4096, input_size=4096, output_size=1,
        pricing_tiers=None,
        output_pricing={
            'video': {
