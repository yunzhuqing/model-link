...
VERTEXAI_TEMPLATES = [
    ...
    dict(label='Claude Opus 4.8 (VertexAI)', provider='VertexAI', name='claude-opus-4-8', alias='claude-opus-4-8',
    ...
    dict(label='Claude Opus 4.7 (VertexAI)', provider='VertexAI', name='claude-opus-4-7', alias='claude-opus-4-7',
         ...
         support_file=True, support_web_search=False, support_tool_search=False,
         support_thinking=True, support_online_image=False, support_online_video=False, support_embedding=False),
    dict(label='Claude Opus 4.6 (VertexAI)', provider='VertexAI', name='claude-opus-4-6', alias='claude-opus-4-6',
         context_size=1000000, input_size=1000000, output_size=128000, pricing_tiers=None,
         input_price=5, output_price=25, cache_creation_price=0, cache_5m_creation_price=6.25, cache_1h_creation_price=10, cache_hit_price=0.5,
         timeout=300,
         support_kvcache=True, support_image=True, support_audio=False, support_video=False,
         support_file=True, support_web_search=False, support_tool_search=False,
         support_thinking=True, support_online_image=False, support_online_video=False, support_embedding=False),
    dict(label='Claude Sonnet 4.6 (VertexAI)', provider='VertexAI', name='claude-sonnet-4-6', alias='claude-sonnet-4-6',
         context_size=1000000, input_size=1000000, output_size=128000, pricing_tiers=None,
    ...
    dict(label='Gemini 3 Pro Preview (VertexAI)', provider='VertexAI', name='gemini-3-pro-preview', alias='gemini-3-pro-preview',
         ...
         support_file=True, support_web_search=True, support_tool_search=False,
         support_thinking=True, support_online_image=True, support_online_video=True, support_embedding=False),
    dict(label='Gemini 3.5 Flash (VertexAI)', provider='VertexAI', name='gemini-3.5-flash', alias='gemini-3.5-flash',
         context_size=1048576, input_size=204800, output_size=65535,
         pricing_tiers=[
             dict(label='<=272k', context_size=1048576, input_size=204800, output_size=65535,
                  input_price=2, output_price=12, cache_creation_price=0, cache_hit_price=0.2),
             dict(label='272k~1M', context_size=1048576, input_size=1048576, output_size=65535,
                  input_price=4, output_price=18, cache_creation_price=0, cache_hit_price=0.4),
         ],
         input_price=2, output_price=12, cache_creation_price=0, cache_hit_price=0.2,
         currency='USD', rpm=1000, tpm=1000000,
         timeout=300,
         support_kvcache=True, support_image=True, support_audio=True, support_video=True,
         support_file=True, support_web_search=True, support_tool_search=False,
