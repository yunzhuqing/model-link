...
BAILIAN_TEMPLATES = [
    ...
    dict(label='Qwen3.7 Max', provider='Bailian', name='qwen3.7-max', alias='qwen3.7-max',
         context_size=1048576, input_size=1014784, output_size=65536,
         pricing_tiers=None,
         input_price=12, output_price=36, cache_creation_price=0, cache_hit_price=2.4,
         currency='CNY', discount=0.5, rpm=30000, tpm=5000000,
         timeout=300,
         support_kvcache=True, support_image=False, support_audio=False, support_video=False,
         support_file=False, support_web_search=False, support_tool_search=False,
         support_thinking=True, support_online_image=False, support_online_video=False, support_embedding=False),
    dict(label='Qwen3.7 Plus', provider='Bailian', name='qwen3.7-plus', alias='qwen3.7-plus',
         context_size=1048576, input_size=262144, output_size=65536,
         pricing_tiers=[
             dict(label='<=256k', context_size=1048576, input_size=262144, output_size=65536,
                  input_price=6, output_price=24, cache_creation_price=0, cache_hit_price=1.2),
             dict(label='256k~1M', context_size=1048576, input_size=1048576, output_size=65536,
                  input_price=6, output_price=24, cache_creation_price=0, cache_hit_price=1.2),
         ],
         input_price=6, output_price=24, cache_creation_price=0, cache_hit_price=1.2,
         currency='CNY', discount=0.8, rpm=30000, tpm=5000000,
         timeout=300,
    ...
    # ── Vidu 图像生成 (百炼托管, Dashscope image-generation API) ─────────
    dict(
        label='Vidu Image Reference2Image',
        provider='Bailian',
        name='vidu/vidu-image_reference2image',
        alias='vidu/vidu-image_reference2image',
    ...
    dict(
        label='Vidu Q3 Fast Reference2Image',
        provider='Bailian',
        name='vidu/viduq3-fast_reference2image',
        alias='vidu/viduq3-fast_reference2image',
        context_size=0, input_size=0, output_size=1,
        pricing_tiers=None,
        input_price=0, output_price=0, cache_creation_price=0, cache_hit_price=0,
        currency='CNY',
    ...
    dict(
        label='Vidu Q2 Pro Reference2Image',
        provider='Bailian',
        name='vidu/viduq2-pro_reference2image',
        alias='vidu/viduq2-pro_reference2image',
        context_size=0, input_size=0, output_size=1,
        pricing_tiers=None,
        input_price=0, output_price=0, cache_creation_price=0, cache_hit_price=0,
        currency='CNY',
    ...
    dict(
        label='Vidu Q2 Fast Reference2Image',
        provider='Bailian',
        name='vidu/viduq2-fast_reference2image',
        alias='vidu/viduq2-fast_reference2image',
        context_size=0, input_size=0, output_size=1,
        pricing_tiers=None,
        input_price=0, output_price=0, cache_creation_price=0, cache_hit_price=0,
        currency='CNY',
    ...
    # ── Happyhorse 视频生成 (Dashscope async video-synthesis) ────────────
    dict(
        label='Happyhorse T2V',
        provider='Bailian',
        name='happyhorse-1.0-t2v',
        alias='happyhorse-1.0-t2v',
        context_size=4096, input_size=4096, output_size=1,
        pricing_tiers=None,
        output_pricing={
            'video': {
    ...
    dict(
        ...
        alias='happyhorse-1.0-video-edit',
        context_size=4096, input_size=4096, output_size=1,
        pricing_tiers=None,
        output_pricing={
            'video': {
