...
BAILIAN_TEMPLATES = [
    ...
    dict(label='Kimi K2.5 (Bailian)', provider='Bailian', name='kimi-k2.5', alias='kimi-k2.5',
         ...
         support_file=False, support_web_search=False, support_tool_search=False,
         support_thinking=True, support_online_image=False, support_online_video=False, support_embedding=False),
    dict(label='Kimi K2.5 Long (Proxy)', provider='Bailian', name='kimi/kimi-k2.5', alias='kimi-k2.5',
    ...
    dict(label='DeepSeek R1 (Bailian)', provider='Bailian', name='deepseek-r1', alias='deepseek-r1-bailian',
         ...
         support_file=False, support_web_search=False, support_tool_search=False,
         support_thinking=True, support_online_image=False, support_online_video=False, support_embedding=False),
    dict(label='DeepSeek V3.2 (Bailian)', provider='Bailian', name='deepseek-v3.2', alias='deepseek-v3.2-bailian',
