"""replace cache_creation_price_time with 5m/1h cache creation price fields
...
def upgrade():
    # ── ml_model_templates ────────────────────────────────────────────
    # Drop old cache_creation_price_time, add cache_5m_creation_price & cache_1h_creation_price
    op.drop_column('ml_model_templates', 'cache_creation_price_time')
    ...
    # ── ml_models ─────────────────────────────────────────────────────
    op.drop_column('ml_models', 'cache_creation_price_time')
    ...
    # ── ml_usage_records ──────────────────────────────────────────────
    # Drop old cache_creation_price_time_unit, add new 5m/1h token & price fields
    op.drop_column('ml_usage_records', 'cache_creation_price_time_unit')
...
def downgrade():
    ...
    op.add_column('ml_usage_records', sa.Column('cache_creation_price_time_unit', sa.Float(), nullable=True, server_default='0'))

    # ── ml_models ─────────────────────────────────────────────────────
    op.drop_column('ml_models', 'cache_1h_creation_price')
    op.drop_column('ml_models', 'cache_5m_creation_price')
    op.add_column('ml_models', sa.Column('cache_creation_price_time', sa.Float(), nullable=True, server_default='0'))

    # ── ml_model_templates ────────────────────────────────────────────
    op.drop_column('ml_model_templates', 'cache_1h_creation_price')
    op.drop_column('ml_model_templates', 'cache_5m_creation_price')
    op.add_column('ml_model_templates', sa.Column('cache_creation_price_time', sa.Float(), nullable=True, server_default='0'))